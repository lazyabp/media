...
{
    [RemoteService(Name = MediaKitServiceConsts.RemoteServiceName)]
    [Area("media")]
    [Route("api/media/upload")]
    public class UploadController : MediaKitController
    {
        ...
        {
            await AuthorizationService.CheckAsync(MediaKitPermissions.Media.Create);
